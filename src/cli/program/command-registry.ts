...
export const commandRegistry: CommandRegistration[] = [
  ...
  {
    id: "pipeline",
    register: ({ program }) => registerPipelineCommands(program),
  },
  {
    id: "digest",
    register: ({ program }) => registerDigestCli(program),
  },
  {
    id: "watch",
    register: ({ program }) => registerWatchCli(program),
  },
];

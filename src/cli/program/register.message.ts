...
${formatHelpExamples([
  ['opin message send --target +25512345678 --message "Hi"', "Send a text message."],
  [
    'opin message send --target +25512345678 --message "Hi" --media photo.jpg',
  ...
  [
    'opin message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.opin.squareexp.com/cli/message")}`,
    )
    .action(() => {

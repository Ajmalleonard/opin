...
export function registerMaintenanceCommands(program: Command) {
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/doctor", "docs.opin.squareexp.com/cli/doctor")}\n`,
    )
  ...
  program
    ...
    .description("Preview or apply Opin state/config migration")
    .option("--apply", "Apply pending state/config migrations", false)
    .action(async (opts) => {
      await runCommandWithRuntime(defaultRuntime, async () => {
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/dashboard", "docs.opin.squareexp.com/cli/dashboard")}\n`,
    )
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/reset", "docs.opin.squareexp.com/cli/reset")}\n`,
    )
  ...
  program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/uninstall", "docs.opin.squareexp.com/cli/uninstall")}\n`,
    )

...
const SANDBOX_EXAMPLES = {
  main: [
    ["opin sandbox list", "List all sandbox containers."],
    ["opin sandbox list --browser", "List only browser containers."],
    ["opin sandbox recreate --all", "Recreate all containers."],
    ["opin sandbox recreate --session main", "Recreate a specific session."],
    ["opin sandbox recreate --agent mybot", "Recreate agent containers."],
    ["opin sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["opin sandbox list", "List all sandbox containers."],
    ["opin sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["opin sandbox recreate --all", "Recreate all containers."],
    ["opin sandbox recreate --session main", "Recreate a specific session."],
    ["opin sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["opin sandbox recreate --browser --all", "Recreate only browser containers."],
    ["opin sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["opin sandbox explain", "Show effective sandbox config."],
    ["opin sandbox explain --session agent:main:main", "Explain a specific session."],
    ["opin sandbox explain --agent work", "Explain an agent sandbox."],
    ["opin sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.opin.squareexp.com/cli/sandbox")}\n`,
    )
    .action(() => {

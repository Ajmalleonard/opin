...
// package.json "opin" metadata (used for onboarding/catalog)
...
export type OpinPackageManifest = {
  extensions?: string[];
  channel?: PluginPackageChannel;
  install?: PluginPackageInstall;
};

export type ManifestKey = ProjectScopedManifestKey;
...
): OpinPackageManifest | undefined {
  return resolveProjectScopedValue<OpinPackageManifest>(manifest);
}

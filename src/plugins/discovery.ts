...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @opin/voice-call -> voice-call).
...
export function discoverOpinPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".opin", "extensions")];

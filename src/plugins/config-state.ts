...
export const normalizePluginsConfig = (config?: OpinConfig["plugins"]): NormalizedPluginsConfig => {
...
const hasExplicitMemorySlot = (plugins?: OpinConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: OpinConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: OpinConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }

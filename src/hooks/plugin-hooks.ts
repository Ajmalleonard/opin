...
import type { OpinPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OpinPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OpinPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,

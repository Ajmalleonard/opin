...
This directory contains hooks that ship with Opin. These hooks are automatically discovered and can be enabled/disabled via CLI or configuration.
...
**Docs**: https://docs.opin.squareexp.com/hooks/soul-evil
...
homepage: https://docs.opin.squareexp.com/hooks#my-hook
...
Hooks can be configured in `~/.opin/opin.json`:
...
2. Restart gateway: `pkill -9 -f 'opin.*gateway' && pnpm opin gateway`
3. Enable the hook: `opin hooks enable my-hook`
4. Trigger the event (e.g., send `/new` command)
5. Check gateway logs for hook execution

## Documentation

Full documentation: https://docs.opin.squareexp.com/hooks

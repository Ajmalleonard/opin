...
export function listSlackAccountIds(cfg: OpinConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: OpinConfig): string {
...
function resolveAccountConfig(cfg: OpinConfig, accountId: string): SlackAccountConfig | undefined {
  const accounts = cfg.channels?.slack?.accounts;
  if (!accounts || typeof accounts !== "object") {
    return undefined;
  }
...
function mergeSlackAccountConfig(cfg: OpinConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpinConfig): ResolvedSlackAccount[] {

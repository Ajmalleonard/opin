...
function resolveMentionPatterns(cfg: OpinConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpinConfig | undefined, agentId?: string): RegExp[] {

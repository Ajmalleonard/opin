...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@opin", { botUsername: "opin" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@opin args", {
        botUsername: "opin",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "opin" })).toBe("/help@otherbot");
  });

...
import { digestHandlers } from "./server-methods/digest.js";
import { execApprovalsHandlers } from "./server-methods/exec-approvals.js";
import { healthHandlers } from "./server-methods/health.js";
import { logsHandlers } from "./server-methods/logs.js";
import { memoryProfileHandlers } from "./server-methods/memory-profile.js";
import { modelsHandlers } from "./server-methods/models.js";
import { nodeHandlers } from "./server-methods/nodes.js";
import { pipelineNaturalHandlers } from "./server-methods/pipeline-natural.js";
...
import { watchHandlers } from "./server-methods/watch.js";
...
function authorizeGatewayMethod(method: string, client: GatewayRequestOptions["client"]) {
  ...
  if (
    ...
    method === "digest.enable" ||
    method === "digest.disable"
  ) {
    return errorShape(ErrorCodes.INVALID_REQUEST, "missing scope: operator.admin");
  }
  return errorShape(ErrorCodes.INVALID_REQUEST, "missing scope: operator.admin");
...
export const coreGatewayHandlers: GatewayRequestHandlers = {
  ...
  ...browserHandlers,
  ...digestHandlers,
  ...memoryProfileHandlers,
  ...watchHandlers,
  ...pipelineNaturalHandlers,
};

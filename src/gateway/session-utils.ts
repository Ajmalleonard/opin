...
import { type OpinConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpinConfig): string[] {
...
export function listAgentsForGateway(cfg: OpinConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpinConfig): string {
  return normalizeAgentId(resolveDefaultAgentId(cfg));
}

export function resolveSessionStoreKey(params: { cfg: OpinConfig; sessionKey: string }): string {
...
function resolveSessionStoreAgentId(cfg: OpinConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: OpinConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: OpinConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: OpinConfig): GatewaySessionsDefaults {

export const GATEWAY_CLIENT_IDS = {
  ...
  CONTROL_UI: "opin-control-ui",
  CONTROL_UI_OPIN: "opin-control-ui",
  WEBCHAT: "webchat",
  CLI: "cli",
  GATEWAY_CLIENT: "gateway-client",
  MACOS_APP: "opin-macos",
  MACOS_APP_OPIN: "opin-macos",
  IOS_APP: "opin-ios",
  IOS_APP_OPIN: "opin-ios",
  ANDROID_APP: "opin-android",
  ANDROID_APP_OPIN: "opin-android",
  NODE_HOST: "node-host",
  TEST: "test",
  FINGERPRINT: "fingerprint",
  PROBE: "opin-probe",
  PROBE_OPIN: "opin-probe",
} as const;

...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.OPIN_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: OpinConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: OpinConfig): string {
...
function mergeTelegramAccountConfig(cfg: OpinConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: OpinConfig): ResolvedTelegramAccount[] {

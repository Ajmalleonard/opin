...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("opin");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "opin");

...
import type { GatewayBindMode, GatewayTailscaleMode, OpinConfig } from "../config/config.js";
...
export async function configureGatewayForOnboarding(
  ...
  if (tailscaleMode !== "off" && flow !== "quickstart") {
    await prompter.note(
      [
        "Docs:",
        "https://docs.opin.squareexp.com/gateway/tailscale",
        "https://docs.opin.squareexp.com/web",
      ].join("\n"),
      "Tailscale",
    );

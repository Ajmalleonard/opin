...
export const A2UI_PATH = "/__opin__/a2ui";

export const CANVAS_HOST_PATH = "/__opin__/canvas";

export const CANVAS_WS_PATH = "/__opin__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.opinCanvasA2UIAction.postMessage(...)
  // - Android: window.opinCanvasA2UIAction.postMessage(...)
  const handlerNames = ["opinCanvasA2UIAction"];
  ...
  globalThis.Opin = globalThis.Opin ?? {};
  globalThis.Opin.postMessage = postToNode;
  globalThis.Opin.sendUserAction = sendUserAction;
  globalThis.opinPostMessage = postToNode;
  globalThis.opinSendUserAction = sendUserAction;

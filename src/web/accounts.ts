...
export function listWhatsAppAuthDirs(cfg: OpinConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpinConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: OpinConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: OpinConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpinConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpinConfig): ResolvedWhatsAppAccount[] {

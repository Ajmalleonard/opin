...
export const DEFAULT_LOG_DIR = "/tmp/opin";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "opin.log"); // legacy single-file path

const LOG_PREFIX = "opin";
...
function resolveSettings(): ResolvedSettings {
  let cfg: OpinConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => OpinConfig;
      };

...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "opin-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<OpinConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<OpinConfig["telegram"]>>,

...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.opin.squareexp.com/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("opin hooks list")}`,
      `  ${formatCliCommand("opin hooks enable <name>")}`,
      `  ${formatCliCommand("opin hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );

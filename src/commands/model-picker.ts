...
function resolveConfiguredModelRaw(cfg: OpinConfig): string {
...
function resolveConfiguredModelKeys(cfg: OpinConfig): string[] {
...
export function applyPrimaryModel(cfg: OpinConfig, model: string): OpinConfig {
...
export function applyModelAllowlist(cfg: OpinConfig, models: string[]): OpinConfig {
  const defaults = cfg.agents?.defaults;
...
export function applyModelFallbacksFromSelection(cfg: OpinConfig, selection: string[]): OpinConfig {

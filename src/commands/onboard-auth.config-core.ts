...
export function applyZaiConfig(cfg: OpinConfig): OpinConfig {
...
export function applyOpenrouterProviderConfig(cfg: OpinConfig): OpinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: OpinConfig): OpinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: OpinConfig): OpinConfig {
...
export function applyOpenrouterConfig(cfg: OpinConfig): OpinConfig {
...
export function applyMoonshotProviderConfig(cfg: OpinConfig): OpinConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: OpinConfig): OpinConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_CN_BASE_URL);
}

function applyMoonshotProviderConfigWithBaseUrl(cfg: OpinConfig, baseUrl: string): OpinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMoonshotConfig(cfg: OpinConfig): OpinConfig {
...
export function applyMoonshotConfigCn(cfg: OpinConfig): OpinConfig {
...
export function applyKimiCodeProviderConfig(cfg: OpinConfig): OpinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpinConfig): OpinConfig {
...
export function applySyntheticProviderConfig(cfg: OpinConfig): OpinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpinConfig): OpinConfig {
...
export function applyXiaomiProviderConfig(cfg: OpinConfig): OpinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OpinConfig): OpinConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpinConfig): OpinConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpinConfig): OpinConfig {
...
export function applyXaiProviderConfig(cfg: OpinConfig): OpinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: OpinConfig): OpinConfig {
...
export function applyQianfanProviderConfig(cfg: OpinConfig): OpinConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: OpinConfig): OpinConfig {

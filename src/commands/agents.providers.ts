...
function resolveDefaultAccountId(cfg: OpinConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpinConfig): boolean {
...
export function summarizeBindings(cfg: OpinConfig, bindings: AgentBinding[]): string[] {

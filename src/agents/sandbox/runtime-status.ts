...
function resolveMainSessionKeyForSandbox(params: { cfg?: OpinConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: OpinConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
...
export function formatSandboxToolPolicyBlockedMessage(params: {
  ...
  lines.push(`- See: ${formatCliCommand(`opin sandbox explain --session ${runtime.sessionKey}`)}`);

...
export const DEFAULT_SANDBOX_IMAGE = "opin-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "opin-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "opin-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "opin-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "opin-sbx-browser-";

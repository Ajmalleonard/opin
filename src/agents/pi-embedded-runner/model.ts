...
// pi-ai's built-in Anthropic catalog can lag behind Opin's defaults/docs.
...
export function buildModelAliasLines(cfg?: OpinConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveOpinAgentDir();

...
import { resolveOpinDocsPath } from "../../docs-path.js";
import { isTimeoutError } from "../../failover-error.js";
import { injectPreferenceProfile } from "../../../memory/memory-injector.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const docsPath = await resolveOpinDocsPath({
      workspaceDir: effectiveWorkspace,
    ...
    const extraSystemPrompt = await injectPreferenceProfile(

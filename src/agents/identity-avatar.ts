...
function resolveAvatarSource(cfg: OpinConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpinConfig, agentId: string): AgentAvatarResolution {

...
function resolveWatchPaths(workspaceDir: string, config?: OpinConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpinConfig }) {

...
function resolveAnthropicDefaultAuthMode(cfg: OpinConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpinConfig): OpinConfig {
...
export function applyTalkApiKey(config: OpinConfig): OpinConfig {
...
export function applyModelDefaults(cfg: OpinConfig): OpinConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpinConfig): OpinConfig {
...
export function applyLoggingDefaults(cfg: OpinConfig): OpinConfig {
...
export function applyContextPruningDefaults(cfg: OpinConfig): OpinConfig {
...
export function applyCompactionDefaults(cfg: OpinConfig): OpinConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }

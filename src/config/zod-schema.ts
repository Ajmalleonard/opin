...
const OpsSchema = z
  .object({
    ...
    mailBaseUrl: z.string().optional(),
    threadBaseUrl: z.string().optional(),
    token: z.string().optional(),
    knowledgeBaseDir: z.string().optional(),
    roleWorkspacesDir: z.string().optional(),
    allowlistedActions: z.array(z.string()).optional(),
  })
  .strict()
  .optional();

export const OpinSchema = z
  .object({
    meta: z
      .object({
          ...
          .record(
            ...
            z
              .object({
                ...
                cdpUrl: z.string().optional(),
                driver: z.union([z.literal("opin"), z.literal("extension")]).optional(),

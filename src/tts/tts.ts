...
export function resolveTtsConfig(cfg: OpinConfig): ResolvedTtsConfig {
...
export function resolveTtsPrefsPath(config: ResolvedTtsConfig): string {
  ...
  const envPath = process.env.OPIN_TTS_PREFS?.trim();
  if (envPath) {
...
export function buildTtsSystemPromptHint(cfg: OpinConfig): string | undefined {
...
function resolveSummaryModelRef(cfg: OpinConfig, config: ResolvedTtsConfig): SummaryModelSelection {

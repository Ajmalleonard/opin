...
describe("update-startup", () => {
  ...
  beforeEach(async () => {
    ...
    tempDir = await fs.mkdtemp(path.join(os.tmpdir(), "opin-update-check-"));
  ...
  it("logs update hint for npm installs when newer tag exists", async () => {
    const { resolveOpinPackageRoot } = await import("./opin-root.js");
    ...
    vi.mocked(resolveOpinPackageRoot).mockResolvedValue("/opt/opin");

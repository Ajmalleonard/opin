...
async function isPluginConfigured(plugin: ChannelPlugin, cfg: OpinConfig): Promise<boolean> {
...
export async function listConfiguredMessageChannels(cfg: OpinConfig): Promise<MessageChannelId[]> {

...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: OpinConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: OpinConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: OpinConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: OpinConfig): void {

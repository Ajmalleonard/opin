...
export function listIMessageAccountIds(cfg: OpinConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: OpinConfig): string {
...
function mergeIMessageAccountConfig(cfg: OpinConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OpinConfig): ResolvedIMessageAccount[] {

---
summary: "CLI reference for `opin browser` (profiles, tabs, actions, extension relay)"
read_when:
  - You use `opin browser` and want examples for common tasks
...
Manage Opin’s browser control server and run browser actions (tabs, snapshots, screenshots, navigation, clicks, typing).
...
- `opin`: launches/attaches to a dedicated Opin-managed Chrome instance (isolated user data dir).

...
Opin has two separate “streaming” layers:
...
When block streaming is enabled, Opin can **merge consecutive block chunks**
...
When draft streaming is active, Opin disables block streaming for that reply to avoid double-streaming.

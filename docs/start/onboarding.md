---
summary: "First-run onboarding flow for Opin (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Opin">
...
<Step title="CLI">
  ...
  The app can install the global `opin` CLI via npm/pnpm so terminal

...
This guide summarizes a sane workflow for working on the pi integration in Opin.
...
- Trigger the agent directly:
  - `pnpm opin agent --message "Hello" --thinking low`
...
State lives under the Opin state directory. Default is `~/.opin`. If `OPIN_STATE_DIR` is set, use that directory instead.

To reset everything:

- `opin.json` for config
...
- [https://docs.opin.ai/testing](https://docs.opin.ai/testing)
- [https://docs.opin.ai/start/getting-started](https://docs.opin.ai/start/getting-started)

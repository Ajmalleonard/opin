...
Opin treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.opin/settings/voicewake.json`

Shape:

```json
{ "triggers": ["opin", "claude", "computer"], "updatedAtMs": 1730000000000 }
```

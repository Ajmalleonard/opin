...
You can point Opin at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Opin
...
- [Anthropic provider](/providers/anthropic) - Native Opin integration with Claude setup-token or API keys

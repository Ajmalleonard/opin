---
summary: "Use Qianfan's unified API to access many models in Opin"
read_when:
...
3. Opin installed on your system
...
4. Copy the API key for use with Opin

## CLI setup

```bash
opin onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Opin Configuration](/gateway/configuration)

---
summary: "Use Synthetic's Anthropic-compatible API in Opin"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Opin registers it as the
...
Note: Opin's Anthropic client appends `/v1` to the base URL, so use

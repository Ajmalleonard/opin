---
summary: "Opinnet refactor: unify network protocol, roles, auth, approvals, identity"
read_when:
...
title: "Opinnet Refactor"
---

# Opinnet refactor (protocol + auth unification)

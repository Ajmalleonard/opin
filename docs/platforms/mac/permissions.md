...
- Same path: run the app from a fixed location (for Opin, `dist/Opin.app`).
...
Workaround: move files into the Opin workspace (`~/.opin/workspace`) if you want to avoid per-folder grants.

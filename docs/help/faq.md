---
summary: "Frequently asked questions about Opin setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Opin?](#whats-the-recommended-way-to-install-and-set-up-opin)
  ...
  - [I can't access docs.opin.ai (SSL error). What now?](#i-cant-access-docsopinai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or opin not recognized](#windows-install-says-git-not-found-or-opin-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Opin on Linux?](#how-do-i-install-opin-on-linux)
  - [How do I install Opin on a VPS?](#how-do-i-install-opin-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Opin to update itself?](#can-i-ask-opin-to-update-itself)
  ...
  - [If I buy a Mac mini to run Opin, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-opin-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Opin instances?](#can-multiple-people-use-one-whatsapp-number-with-different-opin-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Opin on a dedicated machine?](#how-important-is-it-to-run-opin-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Opin in a VM and what are the requirements](#can-i-run-opin-in-a-vm-and-what-are-the-requirements)
- [What is Opin?](#what-is-opin)
  - [What is Opin, in one paragraph?](#what-is-opin-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Opin](#what-are-the-top-five-everyday-use-cases-for-opin)
  - [Can Opin help with lead gen outreach ads and blogs for a SaaS](#can-opin-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Opin run tasks on a schedule or continuously in the background?](#can-opin-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Opin saved locally?](#is-all-data-used-with-opin-saved-locally)
  - [Where does Opin store its data?](#where-does-opin-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Opin?](#how-do-i-completely-uninstall-opin)
...
- [Config basics](#config-basics)
  ...
  - [Can the Opin browser run headless?](#can-the-opin-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Opin instances talk to each other (local + VPS)?](#can-two-opin-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Opin load environment variables?](#how-does-opin-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Opin instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-opin-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Opin but keep it installed?](#how-do-i-completely-reset-opin-but-keep-it-installed)
  ...
  - [Why doesn't Opin reply in a group?](#why-doesnt-opin-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Opin, Flawd, and Krill use for models?](#what-do-opin-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `opin gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-opin-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `opin gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-opin-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Opin in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-opin-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Opin?](#i-closed-my-terminal-on-windows-how-do-i-restart-opin)
  ...
  - [ELI5: `opin gateway restart` vs `opin gateway`](#eli5-opin-gateway-restart-vs-opin-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Opin to inbound DMs?](#is-it-safe-to-expose-opin-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/opin/opin-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   ```bash
   opin health --json
   opin health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://opin.ai/install.sh | bash -s -- --install-method git
```

This installs Opin **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/opin/opin/issues](https://github.com/opin/opin/issues)
[https://github.com/opin/opin/pulls](https://github.com/opin/opin/pulls)
...
- `opin status`: quick snapshot of gateway/agent health + basic config.
- `opin models status`: checks provider auth + model availability.
- `opin doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `opin status --all`, `opin logs --follow`,
`opin gateway status`, `opin health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Opin
...
```bash
git clone https://github.com/opin/opin.git
cd opin
pnpm install
pnpm build
...
If you don't have a global install yet, run it via `pnpm opin onboard`.
...
- If it asks for auth, paste the token from `gateway.auth.token` (or `OPIN_GATEWAY_TOKEN`) into Control UI settings.
- Retrieve it from the gateway host: `opin config get gateway.auth.token` (or generate one: `opin doctor --generate-gateway-token`).

**Not on localhost:**

- **Tailscale Serve** (recommended): keep bind loopback, run `opin gateway --tailscale serve`, open `https://<magicdns>/`. If `gateway.auth.allowTailscale` is `true`, identity headers satisfy auth (no token).
- **Tailnet bind**: run `opin gateway --bind tailnet --token "<token>"`, open `http://<tailscale-ip>:18789/`, paste token in dashboard settings.
...
1. Install Opin on the new machine.
2. Copy `$OPIN_STATE_DIR` (default: `~/.opin`) from the old machine.
3. Copy your workspace (default: `~/.opin/workspace`).
4. Run `opin doctor` and restart the Gateway service.
...
under `~/.opin/` (for example `~/.opin/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-opin-store-its-data),
...
[https://github.com/opin/opin/blob/main/CHANGELOG.md](https://github.com/opin/opin/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.opin.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.opin.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.opin.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docsopinai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/opin/opin/tree/main/docs](https://github.com/opin/opin/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://opin.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://opin.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://opin.ai/install.ps1](https://opin.ai/install.ps1)
...
```bash
curl -fsSL https://opin.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://opin.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://opin.ai/install.sh | bash -s -- --install-method git --verbose
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or opin not recognized
...
**2) opin is not recognized after install**
...
### How do I install Opin on Linux
...
### How do I install Opin on a VPS
...
### Can I ask Opin to update itself
...
opin update
opin update status
opin update --channel stable|beta|dev
opin update --tag <dist-tag|version>
opin update --no-restart
```

If you must automate from an agent:

```bash
opin update --yes --no-restart
opin gateway restart
```
...
`opin onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Opin with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `opin models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `opin models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `opin models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. Opin no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Opin can keep replying while a provider is rate-limited.
...
Opin supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Opin fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `opin.json`.

Steps:

1. Enable the plugin: `opin plugins enable google-gemini-cli-auth`
2. Login: `opin models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Opin needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Opin runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run Opin can I connect it to my MacBook Pro
...
- Use `opin nodes status` / `opin nodes list` to see it.
...
- DM your bot, then run `opin logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Opin instances
...
If you run Opin via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the Opin code install. Your state
(`~/.opin`) and workspace (`~/.opin/workspace`) stay untouched.
...
**Opin-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Opin on a dedicated machine
...
Opin is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Opin in a VM and what are the requirements
...
### What is Opin in one paragraph

Opin is a personal AI assistant you run on your own devices. It replies on the messaging surfaces you already use (WhatsApp, Telegram, Slack, Mattermost (plugin), Discord, Google Chat, Signal, iMessage, WebChat) and can also do voice + a live Canvas on supported platforms. The **Gateway** is the always-on control plane; the assistant is the product.

### What's the value proposition

Opin is not "just a Claude wrapper." It's a **local-first control plane** that lets you run a
...
### What are the top five everyday use cases for Opin
...
### Can Opin help with lead gen outreach ads and blogs for a SaaS
...
Opin draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Opin is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Opin when you
...
Showcase: [https://opin.ai/showcase](https://opin.ai/showcase)

## Skills and automation

### How do I customize skills without keeping the repo dirty

Use managed overrides instead of editing the repo copy. Put your changes in `~/.opin/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.opin/opin.json`). Precedence is `<workspace>/skills` > `~/.opin/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.opin/opin.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.opin/skills` → bundled → `skills.load.extraDirs`. `opinhub` installs into `./skills` by default, which Opin treats as `<workspace>/skills`.
...
- Confirm cron is enabled (`cron.enabled`) and `OPIN_SKIP_CRON` is not set.
...
```bash
opin cron run <jobId> --force
opin cron runs --id <jobId> --limit 50
```
...
Use **OpinHub** (CLI) or drop skills into your workspace. The macOS Skills UI isn't available on Linux.
Browse skills at [https://opinhub.com](https://opinhub.com).

Install the OpinHub CLI (pick one package manager):
...
### Can Opin run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.opin.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-opin-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Opin can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.opin/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "opin": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
```bash
opinhub install <skill-slug>
opinhub update --all
```

OpinHub installs into `./skills` under your current directory (or falls back to your configured Opin workspace); Opin treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.opin/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [OpinHub](/tools/opinhub).
...
- Persist `/home/node` with `OPIN_HOME_VOLUME` so caches survive.
- Bake system deps into the image with `OPIN_DOCKER_APT_PACKAGES`.
...
Opin memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Opin also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, Opin auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Opin
prefers `local`.
...
### Is all data used with Opin saved locally

No - **Opin's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.opin` + your workspace directory).
...
### Where does Opin store its data

Everything lives under `$OPIN_STATE_DIR` (default: `~/.opin`):

| Path                                                        | Purpose                                                      |
| ----------------------------------------------------------- | ------------------------------------------------------------ |
| `$OPIN_STATE_DIR/opin.json`                                 | Main config (JSON5)                                          |
| `$OPIN_STATE_DIR/credentials/oauth.json`                    | Legacy OAuth import (copied into auth profiles on first use) |
| `$OPIN_STATE_DIR/agents/<agentId>/agent/auth-profiles.json` | Auth profiles (OAuth + API keys)                             |
| `$OPIN_STATE_DIR/agents/<agentId>/agent/auth.json`          | Runtime auth cache (managed automatically)                   |
| `$OPIN_STATE_DIR/credentials/`                              | Provider state (e.g. `whatsapp/<accountId>/creds.json`)      |
| `$OPIN_STATE_DIR/agents/`                                   | Per-agent state (agentDir + sessions)                        |
| `$OPIN_STATE_DIR/agents/<agentId>/sessions/`                | Conversation history & state (per agent)                     |
| `$OPIN_STATE_DIR/agents/<agentId>/sessions/sessions.json`   | Session metadata (per agent)                                 |

Legacy single-agent path: `~/.opin/agent/*` (migrated by `opin doctor`).

Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.opin/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.opin`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.opin`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.opin/skills`).

Default workspace is `~/.opin/workspace`, configurable via:

```json5
{
  agents: { defaults: { workspace: "~/.opin/workspace" } },
}
```
...
Do **not** commit anything under `~/.opin` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Opin
...
`workspace` to the repo root. The Opin repo is just source code; keep the
...
Opin reads an optional **JSON5** config from `$OPIN_CONFIG_PATH` (default: `~/.opin/opin.json`):

```
$OPIN_CONFIG_PATH
```

If the file is missing, it uses safe-ish defaults (including a default workspace of `~/.opin/workspace`).

### I set gatewaybind lan or tailnet and now nothing listens the UI says unauthorized

Non-loopback binds **require auth**. Configure `gateway.auth.mode` + `gateway.auth.token` (or use `OPIN_GATEWAY_TOKEN`).
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `opin doctor --generate-gateway-token`.
...
key. **Recommended:** run `opin configure --section web` to store it in
...
- Daemons read env vars from `~/.opin/.env` (or the service environment).
...
### Can the Opin browser run headless
...
- Gateway is running: `opin gateway status`
- Gateway health: `opin status`
- Channel health: `opin channels status`
...
### Can two Opin instances talk to each other local VPS
...
`opin agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
opin agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.opin/opin.json`).
- If you have no backup, re-run `opin doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `opin config set` for small changes.
- Use `opin configure` for interactive edits.
...
{
  agents: { defaults: { workspace: "~/.opin/workspace" } },
  channels: { whatsapp: { allowFrom: ["+25512345678"] } },
}
```
...
### How does Opin load environment variables

Opin reads env vars from the parent process (shell, launchd/systemd, CI, etc.) and additionally loads:

- `.env` from the current working directory
- a global fallback `.env` from `~/.opin/.env` (aka `$OPIN_STATE_DIR/.env`)
...
1. Put the missing keys in `~/.opin/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`OPIN_LOAD_SHELL_ENV=1`, `OPIN_SHELL_ENV_TIMEOUT_MS=15000`.

### I set COPILOTGITHUBTOKEN but models status shows Shell env off Why

`opin models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means Opin won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.opin/.env`:
...
### Is there a way to make a team of Opin instances one CEO and many agents
...
### How do I completely reset Opin but keep it installed
...
```bash
opin reset --scope full --yes --non-interactive
```
...
- If you used profiles (`--profile` / `OPIN_PROFILE`), reset each state dir (defaults are `~/.opin-<profile>`).
- Dev reset: `opin gateway --dev --reset` (dev-only; wipes dev config + credentials + sessions + workspace).
...
headers like `# Heading`), Opin skips the heartbeat run to save API calls.
...
No. Opin runs on **your own account**, so if you're in the group, Opin can see it.
...
```bash
opin directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Opin reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.opin/agents/<agentId>/sessions/`.
...
- Use `opin doctor` to spot stray workspaces and profile mismatches.
...
Opin's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, Opin currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `opin models set ...` (updates just model config)
- `opin configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.opin/opin.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `opin doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do Opin, Flawd, and Krill use for models

- **Opin + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. Opin ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.opin/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `opin agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Opin can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.opin/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.opin/agent/*` (migrated by `opin doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.opin/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `opin models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `opin models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `opin models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.opin/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    opin models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Opin will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: Opin now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Opin uses provider-prefixed IDs like:
...
Opin may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `opin models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
opin models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
opin models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
opin models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
opin models auth order set --provider anthropic --agent main anthropic:default
```
...
```
--port > OPIN_GATEWAY_PORT > gateway.port > default 18789
```

### Why does opin gateway status say Runtime running but RPC probe failed

Because "running" is the **supervisor's** view (launchd/systemd/schtasks). The RPC probe is the CLI actually connecting to the gateway WebSocket and calling `status`.

Use `opin gateway status` and trust these lines:

- `Probe target:` (the URL the probe actually used)
- `Listening:` (what's actually bound on the port)
- `Last gateway error:` (common root cause when the process is alive but the port isn't listening)

### Why does opin gateway status show Config cli and Config service different

You're editing one config file while the service is running another (often a `--profile` / `OPIN_STATE_DIR` mismatch).

Fix:

```bash
opin gateway install --force
```
...
Opin enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `opin gateway --port <port>`.

### How do I run Opin in remote mode client connects to a Gateway elsewhere
...
- `opin gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `opin.control.settings.v1`.

Fix:

- Fastest: `opin dashboard` (prints + copies the dashboard URL, tries to open; shows SSH hint if headless).
- If you don't have a token yet: `opin doctor --generate-gateway-token`.
- If remote, tunnel first: `ssh -N -L 18789:127.0.0.1:18789 user@host` then open `http://127.0.0.1:18789/`.
- Set `gateway.auth.token` (or `OPIN_GATEWAY_TOKEN`) on the gateway host.
- In the Control UI settings, paste the same token.
- Still stuck? Run `opin status --all` and follow [Troubleshooting](/gateway/troubleshooting). See [Dashboard](/web/dashboard) for auth details.
...
- `OPIN_CONFIG_PATH` (per-instance config)
- `OPIN_STATE_DIR` (per-instance state)
- `agents.defaults.workspace` (workspace isolation)
- `gateway.port` (unique ports)

Quick setup (recommended):

- Use `opin --profile <name> …` per instance (auto-creates `~/.opin-<name>`).
- Set a unique `gateway.port` in each profile config (or pass `--port` for manual runs).
- Install a per-profile service: `opin --profile <name> gateway install`.

Profiles also suffix service names (`bot.molt.<profile>`; legacy `com.opin.*`, `opin-gateway-<profile>.service`, `Opin Gateway (<profile>)`).
...
```
opin tui --url ws://<host>:18789 --token <token>
```
...
- macOS: `$OPIN_STATE_DIR/logs/gateway.log` and `gateway.err.log` (default: `~/.opin/logs/...`; profiles use `~/.opin-<profile>/logs/...`)
- Linux: `journalctl --user -u opin-gateway[-<profile>].service -n 200 --no-pager`
- Windows: `schtasks /Query /TN "Opin Gateway (<profile>)" /V /FO LIST`
...
If you run the gateway manually, `opin gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Opin
...
1. Is the Gateway running? `opin gateway status`
2. Is the Gateway healthy? `opin status`
3. Does the UI have the right token? `opin dashboard`
...
```bash
opin channels status
opin channels logs --channel telegram
```
...
### ELI5 opin gateway restart vs opin gateway

- `opin gateway restart`: restarts the **background service** (launchd/systemd).
- `opin gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `opin gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Opin assistant setup](/start/opin) and [Agent send](/tools/agent-send).

CLI sending:

```bash
opin message send --target +25512345678 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Opin to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `opin pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `opin pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `opin doctor` to surface risky DM policies.
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Opin only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
opin pairing approve whatsapp <code>
```

List pending requests:

```bash
opin pairing list whatsapp
```
...
Opin blocks **cross-provider** messaging by default. If a tool call is bound

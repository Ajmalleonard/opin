...
- Install via CLI: `opin plugins install @opin/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `opin plugins install ./extensions/zalo`
   - From npm (if published): `opin plugins install @opin/zalo`
...
- Approve via:
  - `opin pairing list zalo`
  - `opin pairing approve zalo <CODE>`
...
- Example: `opin message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `opin channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `opin logs --follow`

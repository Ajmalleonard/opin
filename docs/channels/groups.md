...
Opin treats group chats consistently across surfaces: WhatsApp, Telegram, Discord, Slack, Signal, iMessage, Microsoft Teams.

## Beginner intro (2 minutes)

Opin “lives” on your own messaging accounts. There is no separate WhatsApp bot user.
If **you** are in a group, Opin can see that group and respond there.
...
Translation: allowlisted senders can trigger Opin by mentioning it.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@opin", "opin", "\\+25512345678"],
          historyLimit: 50,
        },
      },
    ],

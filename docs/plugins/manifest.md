...
read_when:
  - You are building a Opin plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (opin.plugin.json)

Every plugin **must** ship a `opin.plugin.json` file in the **plugin root**.
Opin uses this manifest to validate configuration **without executing plugin

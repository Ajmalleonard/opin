...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .opinSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OpinPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OpinPaths.stateDirURL.path
...
extension Notification.Name {
    static let opinSelectSettingsTab = Notification.Name("opinSelectSettingsTab")
}

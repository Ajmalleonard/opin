...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OpinConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OpinConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OpinConfigFile.loadDict()
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/opin"
        state.remoteCliPath = ""
        return state
    }
}

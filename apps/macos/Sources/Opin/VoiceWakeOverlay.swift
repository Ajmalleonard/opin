...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.opin", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Opin windows, but below the system’s pop-up menus.

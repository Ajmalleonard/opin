...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.opin", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.opin", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OpinChatMessage] = messages.compactMap { item in

...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/Ajmalleonard/opin") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/Ajmalleonard/opin")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://opin.squareexp.com")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "OpinBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "OpinBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OpinGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpinGitCommit") as? String) ??
            "unknown"
    }

...
enum UIStrings {
    static let welcomeTitle = "Welcome to Opin"
}
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: OpinOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: OpinChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g opin@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OpinChatViewModel(

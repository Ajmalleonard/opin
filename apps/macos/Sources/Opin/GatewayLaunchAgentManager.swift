...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.opin", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".opin/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.opinCommand(
            subcommand: "gateway",

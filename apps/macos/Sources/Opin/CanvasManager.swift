...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.opin", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Opin/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__opin__/a2ui/").absoluteString + "?platform=macos"
    }

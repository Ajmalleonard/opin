...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.opin.gateway"
    private static let nodeService = "ai.opin.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.opin.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.opin.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("opin-gateway.log")
    }

...
final class ScreenController {
    ...
    /// Callback invoked when an opin:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = OpinKitResources.bundle
...
/// Handles navigation policy to intercept opin:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept opin:// deep links.
        if url.scheme?.lowercased() == "opin" {

...
public enum OpinCanvasA2UICommand: String, Codable, Sendable {
...
public struct OpinCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OpinCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {

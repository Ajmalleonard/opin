...
public enum OpinTalkCommand: String, Codable, Sendable {
...
public struct OpinTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OpinTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String

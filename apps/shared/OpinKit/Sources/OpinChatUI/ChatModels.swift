...
public typealias OpinPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OpinPlatformImage = UIImage
#endif

public struct OpinChatUsageCost: Codable, Hashable, Sendable {
...
public struct OpinChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OpinChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OpinChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OpinChatMessageContent: Codable, Hashable, Sendable {
...
public struct OpinChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OpinChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OpinChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OpinChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OpinChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OpinChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OpinChatMessageContent].self, forKey: .content) {
...
public struct OpinChatHistoryPayload: Codable, Sendable {
...
public struct OpinSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OpinSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OpinSessionPreviewItem]
}

public struct OpinSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OpinSessionPreviewEntry]

    public init(ts: Int, previews: [OpinSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OpinChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OpinChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OpinAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OpinChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OpinGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OpinPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OpinPlatformImage?
...
public struct OpinChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String

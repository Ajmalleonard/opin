...
@MainActor
public struct OpinChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: OpinChatViewModel
    ...
    private var visibleMessages: [OpinChatMessage] {
        let base: [OpinChatMessage]
    ...
    private func mergeToolResults(in messages: [OpinChatMessage]) -> [OpinChatMessage] {
    ...
    private func isToolResultMessage(_ message: OpinChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: OpinChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: OpinChatMessage) -> String {

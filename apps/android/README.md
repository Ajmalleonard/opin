## Opin Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_opin-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm opin gateway --port 18789 --verbose
```

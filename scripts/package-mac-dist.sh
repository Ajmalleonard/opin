...
# Output:
# - dist/Opin.app
# - dist/Opin-<version>.zip
# - dist/Opin-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Opin-$VERSION.zip"
DMG="$ROOT_DIR/dist/Opin-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Opin-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Opin-$VERSION.dSYM.zip"

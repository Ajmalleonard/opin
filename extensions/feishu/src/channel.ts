import type { ChannelMeta, ChannelPlugin, OpinConfig } from "opin/plugin-sdk";
import { DEFAULT_ACCOUNT_ID, PAIRING_APPROVED_MESSAGE } from "opin/plugin-sdk";

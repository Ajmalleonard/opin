...
export function listMattermostAccountIds(cfg: OpinConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpinConfig): string {
...
function mergeMattermostAccountConfig(cfg: OpinConfig, accountId: string): MattermostAccountConfig {
...
export function listEnabledMattermostAccounts(cfg: OpinConfig): ResolvedMattermostAccount[] {

import type { ChannelOnboardingAdapter, OpinConfig, WizardPrompter } from "opin/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.opin.squareexp.com/channels/mattermost",
    ].join("\n"),

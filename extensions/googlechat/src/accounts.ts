...
export function listGoogleChatAccountIds(cfg: OpinConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpinConfig): string {
...
function mergeGoogleChatAccountConfig(cfg: OpinConfig, accountId: string): GoogleChatAccountConfig {
...
export function listEnabledGoogleChatAccounts(cfg: OpinConfig): ResolvedGoogleChatAccount[] {

...
export function listZalouserAccountIds(cfg: OpinConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpinConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpinConfig, accountId: string): ZalouserAccountConfig {

...
export function listBlueBubblesAccountIds(cfg: OpinConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: OpinConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: OpinConfig): ResolvedBlueBubblesAccount[] {

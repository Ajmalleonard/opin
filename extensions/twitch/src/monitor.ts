...
import type { ReplyPayload, OpinConfig } from "opin/plugin-sdk";
import { createReplyPrefixOptions } from "opin/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as OpinConfig;

...
} from "opin/plugin-sdk";

// OAuth constants - decoded from pi-ai's base64 encoded values to stay in sync
const decode = (s: string) => Buffer.from(s, "base64").toString();
const CLIENT_ID = process.env.OPIN_GEMINI_OAUTH_CLIENT_ID || decode(
  "==QbvNmL05WZ052bjJXZzVXZsd2bvdmLzBHch5CclNDM0cGNop2bs9Gd2VzMyUmcjxWMygmMul2czhWb01SM5UDM2AjNwATM3ATM".split("").reverse().join("")
);
const CLIENT_SECRET = process.env.OPIN_GEMINI_OAUTH_CLIENT_SECRET || decode(
  "=YWQEFnN6RzQYNHOCxUbxoETkxkN4QjUXZEO1sULYB1UD90R".split("").reverse().join("")
);
...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Opin Antigravity OAuth</title>
  </head>
  <body>
    <main>
